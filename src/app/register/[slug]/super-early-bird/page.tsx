...
export const metadata: Metadata = {
  title: "Super Early Bird Registration - Enthusiast Fun Run",
  description:
    "Register for the Enthusiast Fun Run super early bird special! Secure your spot in the CATEGORY_5K or CATEGORY_10K run and enjoy exclusive benefits. Limited super early bird slots available, so sign up now to take advantage of this special offer.",
};
